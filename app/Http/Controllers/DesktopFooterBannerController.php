...
class DesktopFooterBannerController extends Controller
{
    public function desktop_preview()
    {
        $request = Request::create('/api/footer_banner/desktop', 'GET');
    ...
    public function index()
    {
        ...
        $listActiveBanner = FooterBanner::getLiveList('desktop');
        $listDraftBanner = FooterBanner::getDraftList('desktop');
        ...
        return Inertia::render('Admin/Banner/FooterBannerSetting/DesktopIndex', [
