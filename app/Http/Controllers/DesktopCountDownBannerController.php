...
class DesktopCountDownBannerController extends Controller
{
    public function desktop_preview()
    {
        $request = Request::create('/api/countdown_banner/desktop', 'GET');
    ...
    public function index()
    {
        ...
        $listActiveBanner = CountdownBanner::getLiveList('desktop');
        $listDraftBanner = CountdownBanner::getDraftList('desktop');
        ...
        return Inertia::render('Admin/Banner/CountdownBannerSetting/DesktopIndex', [
