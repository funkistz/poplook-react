...
class MobileTopBannerController extends Controller
{
    public function mobile_preview()
    {
        // $response = Http::timeout(10)->get('/api/home_banner/mobile');
        $request = Request::create('/api/top_banner/mobile', 'GET');
    ...
    public function index()
    {
        ...
        $listActiveBanner = TopBanner::getLiveList('mobile');
        $listDraftBanner = TopBanner::getDraftList('mobile');
        ...
        return Inertia::render('Admin/Banner/TopBannerSetting/MobileIndex', [
