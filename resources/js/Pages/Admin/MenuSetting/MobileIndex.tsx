...
import { MenuList } from '@/features/desktop_menu';
        ...
        <>
            ...
            {menu && <>
                <Card p='xl' radius='lg' withBorder shadow='xs' mt={'lg'}>
                    <MenuList activeIndex={activeParentIndex} setActiveIndex={setActiveParentIndex} data={menu} setMenuBlock={setMenuBlock} setMenuDetail={setMenuDetail} onSubmit={onSubmit} type={'mobile'} />

                    <Divider mt={10} mb={20} />

                    <div ref={previewRef}><MobileMenuPreview data={menu.block} setActiveIndex={setActiveParentIndex} /></div>
                </Card>
            </>}
...
DesktopMenuSettingPage.layout = (page: any) => <AdminLayout children={page} title='Mobile Menu Setting' />;
