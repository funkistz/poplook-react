...
export default function BannerPage() {
    ...
    const url = 'desktop_exit_intent_banner';
...

                        {
                            (block != null) ? (
                                <Box style={{ transition: 'width 0.2s' }} m={0} mt={10} mb={40}>
                                    <BlockCreator oneParentOnly={true} />
                                </Box>
                            ) : (
                                <Flex bg={'#fff'} p={10}>
...
BannerPage.layout = (page: any) => <AdminLayout children={page} title='Desktop Exit Intent Banner Setting' />;
