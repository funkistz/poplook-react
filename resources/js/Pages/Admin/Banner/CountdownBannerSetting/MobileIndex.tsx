...
export default function MobileCountDownBanner() {
    ...
    const url = 'mobile_countdown_banner';
...
MobileCountDownBanner.layout = (page: any) => <AdminLayout children={page} title='Mobile Countdown Banner Setting' />;
