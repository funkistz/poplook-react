...
export default function DesktopFooterBannerPage() {

    const { block, shop } = useSelector((storeState: any) => storeState.block);
    const dispatch = useDispatch<ThunkDispatch<any, any, any>>();
    const url = 'desktop_footer_banner';
    ...
    useEffect(() => {
        ...
        if (listBanner.active && listBanner.active[0] != undefined) {
            // setPrimaryKey(listBanner.active[0].id);
            ...
            setData({
                ...
                start_at: checkDate,
                width: listBanner.active[0].width,
                position: listBanner.active[0].position,
            })
...
DesktopFooterBannerPage.layout = (page: any) => <AdminLayout children={page} title='Desktop Footer Banner Setting' />;
