...
export default function MobileFooterBannerPage() {

    const { block, shop } = useSelector((storeState: any) => storeState.block);
    const dispatch = useDispatch<ThunkDispatch<any, any, any>>();
    const url = 'mobile_footer_banner';
...
MobileFooterBannerPage.layout = (page: any) => <AdminLayout children={page} title='Mobile Footer Banner Setting' />;
