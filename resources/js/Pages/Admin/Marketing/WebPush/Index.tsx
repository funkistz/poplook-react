...
import { Group, rem, ActionIcon, Tooltip, Text, Drawer, Stack, Menu } from '@mantine/core';
    ...
    const tableData = (data: any[]) => {
        ...
        data && data.map((value: any, index: any) => {
            ...
            values.push({
                ...
                'name': <Text fz={14} onClick={() => router.get(url + '/' + value.uuid + '/segment')} style={{ cursor: 'pointer' }}>
                    {value.campaign_name}
                </Text>,
                        ...
                        <Menu trigger="hover" openDelay={100} shadow="md"  position="left-start" offset={-5}>
                            ...
                            <Menu.Dropdown>
                                <Menu.Item 
                                    ...
                                    disabled={disabledBtn(value.campaign_status)}
                                    >
                                    Duplicate
                                </Menu.Item>
...
AppNotification.layout = (page: any) => <AdminLayout children={page} title='Web Push' />;
